...
map_msg = rospy.Subscriber('/map', OccupancyGrid, map_cb)
rate=rospy.Rate(10)
...
#class for implementing WFD algorithm
class Node:
  ...
  def __init__(self,start,goal):
    ...
    self.isFrontierPoint==False
  
  # check for frontier points 
  def checkFrontier(self, map):


def wfd(start):
  pose=complex(start,mapopenlist)
  queuem.append(pose)
  # p = queuem.pop(0)
  #ob1.indication = MOCL
